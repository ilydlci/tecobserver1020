resource "aws_api_gateway_rest_api" "my_gateway" {
  ...
  description = "TecObserver Terraform Example"
}
...
# Root methods & integrations
resource "aws_api_gateway_method" "proxy_root" {
  rest_api_id   = aws_api_gateway_rest_api.my_gateway.id
  resource_id   = aws_api_gateway_rest_api.my_gateway.root_resource_id
  http_method   = "ANY"
  authorization = "NONE"
}
...
output "base_url" {
  value = aws_api_gateway_deployment.my_gateway_deployment.invoke_url
}
